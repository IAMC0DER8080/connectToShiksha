                           ...
                           <div class="nav-tabs-custom ">
                              ...
                              <div class="tab-content">
                                       ...
                                       <table class="table order-table table-custom table-striped" id= "example">
                                          ...
                                          <c:if test="${not empty lectureList}">  
						                	<c:forEach var="data" items="${lectureList}" >
                                             ...
                                             <tr>
                                             <%--  <%counter++; %> --%>
                                           <%--   <c:forEach var="content" items="${data}" varStatus="loop"> --%>
                                             
                                             <%-- <c:choose> --%>
                                            <%--  <c:when test="${loop.index==0}"> --%>
                                                <td><a  href="/connect-to-class/view-training/${data.lectureId}">${data.topic}</a></td>  <!-- ${data.topic}/${object}/uat -->
                                                <%-- </c:when> --%>
                                               <%--  <c:otherwise> --%>
                                                 <td>${data.subject}</td>
                                                  <td>${data.lecturedate}</td>
                                              <%--   </c:otherwise> --%>
                                             <%-- </c:choose> --%>
                                                </tr>
                                                </c:forEach>
                                           ...
                                           <%--   <c:forEach var="content" items="${data}" varStatus="loop"> --%>
                                             ...
                                             <%-- <c:choose> --%>
                                            <%--  <c:when test="${loop.index==0}"> --%>
                                                <td><a  href="/connect-to-class/view-assignment/${data.assignmentId}">${data.topic}</a></td>
                                                <%-- </c:when> --%>
                                               <%--  <c:otherwise> --%>
                                                 <td>${data.subject}</td>
                                ...
                                <%--  <div id="menu1" class="container tab-pane fade">
                                    <div class=" table-responsive">
                                       <table class="table order-table table-custom table-striped" id= "example2">
                                          <thead>
                                             <tr>
                                                <c:if test="${not empty headerList}">  
						                	<c:forEach var="data" items="${headerList}" >
                                          ...
                                          <tbody>
						                	...
						                	<c:forEach var="data" items="${prodList}" >
                                             <tr>
                                              <%counter1++; %>
                                             <c:forEach var="content" items="${data}" varStatus="loop">
                                             ...
                                             <c:choose>
                                             <c:when test="${loop.index==0}">
                                                <td><a  href="/connect-to-class/compare-page/${content}/${object}/prod">${content}</a></td>
                                                </c:when>
                                                <c:otherwise>
                                                 <td>${content}</td>
                                                </c:otherwise>
