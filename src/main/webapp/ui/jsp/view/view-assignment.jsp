		...
		<div class="row">
			<div class="col-12">
				<div class="page-head-box">
					...
					<h4 class="page-head">View Assignment</h4>
				</div>
			</div>
		</div>
				...
				<div class="row noStrech">
						...
						<div class="form-row">
							...
							<div class="form-group1 col-md-6">
								<div class="form-group1 venue-field">
									...
									<form:input style="margin-left: -8px;" type="text" class="form-control" id="venueDetails" placeholder="" path="subject" onkeypress="return isAlphaNumeric(event)" maxlength="200" />
					...
					<div class="col-lg-5 custom-card-width card-right">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<button type="button" id="cancel_Button" class="view-sheet-btn btn-outline-primary" onclick="location.href='/connect-to-class/view-submissions/${assignment.assignmentId}';">
