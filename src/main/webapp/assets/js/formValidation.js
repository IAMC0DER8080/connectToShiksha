$(document).ready(function() {
    ...
    $("#userName").on('blur', function() {
        if ($(this).val() === 'undefine' || $(this).val() == "" || !$(this).val().trim().match(/^[a-zA-Z0-9]+$/)) {   ///^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)
...
function loginValidation() {
    ...
    if ($("#userName").val() === 'undefine' || $("#userName").val() == "" || !$("#userName").val().trim().match(/^[a-zA-Z0-9]+$/)) { //!$("#userName").val().trim().match(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)
        $("#userNmae_error").text("Please enter valid user name.");
        status = false;
    }
